            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2 space-x-3">
                    ...
                    <button
                        ...
                        type="button"
                        className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-light rounded-lg md:hidden hover:bg-gray-dark focus:outline-none focus:ring-2 focus:ring-yellow"
